...
2.	
3.	Targets: Monthly sales targets for each salesperson.
4.	
5.	Calendar Dimension: Monthly dates, enhanced with "Year" and "Month Name" columns for easier analysis.
6.	
7.	People Dimension: Metadata regarding the sales team.
8.	
### Key ETL Steps:
